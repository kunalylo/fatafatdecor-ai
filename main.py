...
DETECT_SYSTEM_PROMPT = (
    ...
    "• FILLERS ARE MANDATORY: every organic garland is packed with 5\" (and often 8\")\n"
    "  filler balloons wedged in the gaps BETWEEN the big balloons — they are what\n"
    "  makes the garland look full. Look INTO the gaps and along the garland's tail.\n"
    "  If your list for a garland has no 5\"/8\" rows, you have missed them — go back\n"
    "  and count again. Typically 30-40%% of a garland's balloons are fillers.\n"
    "• SIZES RUN CONTINUOUSLY: a garland showing 5\" and 12\" balloons of a colour\n"
    "  ALWAYS also contains the 8\" tier between them — emit a row for it. Never\n"
